...
public class WriteUniversityReview {
    ...
    public WriteUniversityReview(int UnireviewID, int UniversityID, int StudentID, String Content, int Rating, LocalDate Dateposted) {
